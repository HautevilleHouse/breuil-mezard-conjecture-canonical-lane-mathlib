# Breuil Mezard Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/breuil-mezard-conjecture-canonical-lane-mathlib.git
cd breuil-mezard-conjecture-canonical-lane-mathlib
lake exe
lake build
```
